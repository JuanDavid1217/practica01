...
public class OptionsForm extends javax.swing.JInternalFrame {
    ...
    private void aceptarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarButtonActionPerformed
        if(empleado!=null){
            if (option==1){
                int pase=JOptionPane.showConfirmDialog(null, "Estas seguro de actualizar el empleado con id "+empleado.getClave()+"?", "Actualización", JOptionPane.YES_NO_OPTION);
                if(pase==0){
                    DAOEmpleado daoEmpleado=new DAOEmpleado();
                    Empleado emp=new Empleado();
                    emp.setClave(empleado.getClave());
                    emp.setNombre(nombreEntrada.getText());
                    emp.setDireccion(direccionEntrada.getText());
                    daoEmpleado.update(emp, empleado.getClave());
                ...
                int pase=JOptionPane.showConfirmDialog(null, "Estas seguro de eliminar el empleado con id "+empleado.getClave()+"?", "Actualización", JOptionPane.YES_NO_OPTION);
                if(pase==0){
                    DAOEmpleado daoEmpleado=new DAOEmpleado();
                    daoEmpleado.delete(empleado.getClave());
    ...
    private void buscarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarButtonActionPerformed
        ...
        try{
            ...
            if(id!=0){
                ...
                if(empleado!=null&&empleado.getClave()!=0){
                    nombreEntrada.setText(empleado.getNombre());
                    direccionEntrada.setText(empleado.getDireccion());
                }else{
